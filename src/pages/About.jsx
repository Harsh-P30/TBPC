          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-muted-foreground text-lg animate-fade-in animate-delay-100">
                Founded in 2017, <strong>TECH BROTHERS POLYMER CORPORATION</strong> is dedicated to creating premium plastic products
              ...
              <p>
                Every <strong>TECH BROTHERS POLYMER CORPORATION</strong> product starts with identifying a need or opportunity to improve
