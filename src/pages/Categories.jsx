...
const CategoriesPage = () => {
  const categories = [
    ...
    },
    {
      ...
      image: 'https://staranddaisy.in/wp-content/uploads/2023/04/newcupboard12423_8.jpg',
    },
    {
      id: 'furniture',
      name: 'Furniture',
...
const CategoryCard = ({ category, index }) => {
  return (
    <Link
      ...
      className={`group relative rounded-lg overflow-hidden cursor-pointer animate-scale-in animate-delay-${index * 100}`}
    >
